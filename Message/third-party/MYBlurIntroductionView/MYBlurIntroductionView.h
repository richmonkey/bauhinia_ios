...
/******************************/
@interface MYBlurIntroductionView : UIScrollView <UIScrollViewDelegate>{
    NSArray *Panels;
...
//Delegate
@property (weak) id <MYIntroductionDelegate> theDelegate;

@property (nonatomic, retain) UIView *BlurView;
@property (nonatomic, retain) UIView *BackgroundColorView;
@property (retain, nonatomic) UIImageView *BackgroundImageView;
@property (retain, nonatomic) SWParallaxScrollView *MasterScrollView;
