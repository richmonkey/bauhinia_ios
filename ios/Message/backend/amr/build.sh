...
do  
    ...
    arm*)  
        ...
        CXX="xcrun --sdk iphoneos clang++ -arch $arch $IOSMV --sysroot=$SDK -isystem $SDK/usr/include -fembed-bitcode-marker" \
    ...
    *)
        ...
        CXX="xcrun --sdk iphonesimulator clang++ -arch $arch $IOSMV -fembed-bitcode-marker" \
        ./configure \
        --prefix=$DEST/$arch \
        --disable-shared
        ;;
