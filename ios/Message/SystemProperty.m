...
#define  kBackgroundKey         @"backgroundStr"
...
- (NSString*) backgroundString{
    ...
    return [settings objectForKey:kBackgroundKey];
    
}

-(void) setBackgroundString:(NSString *) ImgStr{
    NSString *plistPath = [[NSBundle mainBundle] pathForResource:@"setting" ofType:@"plist"];
    NSMutableDictionary *settings = [[NSMutableDictionary alloc] initWithContentsOfFile:plistPath];
    
    [settings setObject:ImgStr forKey:kBackgroundKey];
